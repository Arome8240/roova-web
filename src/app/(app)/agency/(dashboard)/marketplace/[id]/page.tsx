...
import { ListingDetailContent } from "@/features/marketplace/components/agency/listing-detail-content";
...
export async function generateMetadata({
  ...
  return {
    title: listing ? `${listing.title} — Agency Dashboard | Roova` : "Listing — Roova",
  };
}
